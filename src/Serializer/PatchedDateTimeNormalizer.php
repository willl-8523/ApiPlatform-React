...
class PatchedDateTimeNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    public function denormalize($data, string $type, string $format = null, array $context = [])
    {
        ...
        try {
            ...
            /**
             * Si il n'a pas reussi à creer une nouvelle dateTime (new \DateTime($data,
             * $timezone))
             * 
             * Si $context['disabled_type_enforcement'] existe (=true) sinon prend
             * false par defaut => return data (donnée entrée dans sentAt)
             */
